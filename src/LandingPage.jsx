              ...
              {[
                {
                  ...
                  fallbackEmoji: "🚀",
                  caption: "Aceleración de startups",
                  meta: "Workshop · Buenos Aires",
                },
                {
                  src: "fotos/event-3.jpg",
                  fallbackEmoji: "🤖",
                  caption: "Uso de IA",
                  meta: "Charla · San Pedro",
                },
                {
                  src: "fotos/event-4.jpg",
                  fallbackEmoji: "🍽️",
                  caption: "IA aplicada a cadenas gastronómicas",
                  meta: "Capacitación corporativa",
                },
                {
                  src: "fotos/event-5.jpg",
                  fallbackEmoji: "⚡",
                  caption: "Aceleradora Sparklab",
                  meta: "Programa de aceleración",
                },
                {
                  src: "fotos/event-6.jpg",
                  fallbackEmoji: "💼",
                  caption: "Charla de negocios",
                  meta: "Conferencia · San Pedro",
                },
                {
                  src: "fotos/event-7.jpg",
                  fallbackEmoji: "🎯",
                  caption: "Impacto IA",
                  meta: "Invitado principal",
                },
                {
                  src: "fotos/event-podcast.jpg",
                  fallbackEmoji: "🎙️",
                  caption: "Entrevista en podcast",
                  meta: "Negocios · Internacional",
                },
                {
                  src: "fotos/event-2014.jpg",
                  fallbackEmoji: "🏢",
                  caption: "Negocios en mercado inmobiliario",
                  meta: "Charla · 2014",
                },
              ].map((ev, i) => (
                <FadeIn key={i} delay={i * 0.08}>
